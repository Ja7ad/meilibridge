...
INSERT INTO USER (id, name, email, profile, age, birth_date, is_active, balance, created_at, updated_at)
    VALUES (1, 'Alice', 'alice@example.com', '{"age": 30, "address": {"city": "Wonderland", "street": "123 Rabbit Hole"}}', 30, '1991-04-12', TRUE, 1000.50, '2023-07-20 14:30:00', '2024-07-20 14:30:00'),
...
INSERT INTO book (id, title, user_id, published_date, metadata)
    VALUES (1, 'Golang Programming', 1, '2021-01-01', '{"genre": "Technology", "pages": 350, "publisher": {"name": "Tech Books", "location": "USA"}}'),
